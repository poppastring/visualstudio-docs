...
- [IDiaSymbol10::get_sourceLink](../debugger/debug-interface-access/idiasymbol10-get-sourcelink.md) - Fix typo: Retreives -> Retrieves

### Modeling

**Updated articles**

- [Browse and rearrange code maps](../modeling/browse-and-rearrange-code-maps.md) - Fix typo: inactivate -> deactivate
...
- [MSBuild response files](../msbuild/msbuild-response-files.md) - Add note - clarifying Visual Studio ignores .rsp files (fixes #11466)

### Python

**Updated articles**

- [Create a C++ extension for Python in Visual Studio](../python/working-with-c-cpp-python-in-visual-studio.md) - Fix typo: complier -> compiler

### SharePoint

**Updated articles**

- [Associations between entities](../sharepoint/creating-an-association-between-entities.md) - Fix typo: assocation -> association
- [Create an association between entities](../sharepoint/how-to-create-an-association-between-entities.md) - Fix typo: assocation -> association
