...
- [What is GitHub Copilot Completions for Visual Studio?](../ide/visual-studio-github-copilot-extension.md) - Add keyboard shortcuts to the completions documentation

### Install

**Updated articles**

- [Install and use Visual Studio and Azure Services behind a firewall or proxy server](../install/install-and-use-visual-studio-behind-a-firewall-or-proxy-server.md) - Updating Remote Settings and Telemetry endpoints

### MSBuild

**Updated articles**

- [Customize the build by folder](../msbuild/customize-by-directory.md) - Change inline code to code block for better copy friendliness
- [ZZZ - Title not found in: #10673](../msbuild/errors/msb8088.md) - Fix MSB8088 message in blockquotes
