...
- [IDiaInputAssemblyFile](../debugger/debug-interface-access/idiainputassemblyfile.md) - Fix typo: orginal -> original
- [IDiaInputAssemblyFile::get_fileName](../debugger/debug-interface-access/idiainputassemblyfile-get-filename.md) - Fix typo: orginal -> original
- [IDiaInputAssemblyFile::get_version](../debugger/debug-interface-access/idiainputassemblyfile-get-version.md) - Fix typo: orginal -> original
